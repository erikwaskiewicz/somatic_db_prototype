...
class GeneCoverageAnalysisAdmin(admin.ModelAdmin):
    list_display = ('id', 'sample', 'gene', 'av_coverage', 'percent_500x', 'percent_270x', 'percent_135x')
    search_fields = ['id', 'sample__id', 'gene__gene', 'av_coverage', 'percent_500x', 'percent_270x', 'percent_135x']

admin.site.register(GeneCoverageAnalysis, GeneCoverageAnalysisAdmin )


class RegionCoverageAnalysisAdmin(admin.ModelAdmin):
    list_display = ('id', 'gene', 'hgvs_c', 'genomic', 'average_coverage', 'percent_500x', 'percent_270x', 'percent_135x')
    search_fields = ['id', 'gene__id', 'hgvs_c', 'average_coverage', 'percent_500x', 'percent_270x', 'percent_135x']
